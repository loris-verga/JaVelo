...
class BitsTest {
    ...
    void extractSignedWorksOnKnownValues(){
        ...
        var actual1 = Bits.extractSigned(0b11001010111111101011101010111110, 0,0);
        var expected1 = 0b0;
        ...
        var actual4 = Bits.extractSigned(0b11001010111111101011101010111110, 18,4);
    ...
    void extractUnsignedWorksOnKnownValues(){
        ...
        var actual4 = Bits.extractUnsigned(0b11001010111111101011101010111110, 18,4);
        var expected4 = 0b1100;
        assertEquals(expected4,actual4);

        //todo check if this is correct
        var actual5 = Bits.extractUnsigned(0b11001010111111101011101010111110, 0,32);
        var expected5 = 0b11001010111111101011101010111110;
        assertEquals(expected5,actual5);
    }
